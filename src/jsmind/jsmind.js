...
define(function (require, exports, module) {
    ...
    jm.prototype={
        init : function(){
            ...
            //@delete this.shortcut = new jm.shortcut_provider(this, opts.shortcut);

            this.data.init();
            this.layout.init();
            this.view.init();
            //@delete this.shortcut.init();

            //@delete this._event_bind();
...
// ============= data provider =============================================
    ...
    jm.data_provider.prototype={
        ...
        load:function(mind_data){
            ...
            if(df in jm.format){
                mind = jm.format[df].get_mind(mind_data);
            }else{
        ...
        get_data:function(data_format){
            var data = null;
            if(data_format in jm.format){
                data = jm.format[data_format].get_data(this.jm.mind);
            }else{
